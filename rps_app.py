...
with tab_camera:
    ...
    if model_url and uploaded_hand:
        ...
        with col_left:
            ...
            st.info(f"컴퓨터 선택: {EMOJI[computer_choice_ai]} {computer_choice_ai}")

        with col_right:
            html_code = """
            <div style="font-family:-apple-system, sans-serif;">
              <div id="status" style="color:#555; margin-bottom:10px;">AI 분석 진행 중... ⏳</div>
                ...
                try {
                  ...
                  imgEl.onload = async () => {
                    ...
                    if (BEATS[player] === undefined) {
                      resultBox.innerHTML =
                        "⚠️ 클래스 이름이 '가위/바위/보' 또는 'scissors/rock/paper'와 일치하지 않아 승패 판정이 불가능합니다.";
                      return;
                    }
        ...
        st.info("카메라 촬영 또는 파일 업로드를 완료하면 인식 결과와 대결이 시작됩니다.")